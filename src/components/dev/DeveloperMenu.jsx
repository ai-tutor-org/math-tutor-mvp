...
const DeveloperMenu = ({
    ...
    }, [ttsRef, setIsSpeaking, setShowNextButton, setDynamicTutorText, setAnimationTrigger, setActiveFeedbackInteraction, setCurrentPresIndex, setCurrentInteractionIndex]);
